package ReflectionAndAnnotation.Exercises.barracksWars.data;
...
public class UnitRepository implements Repository {
	...
	public void removeUnit(String unitType)  {
		Integer unitTypeAmount = this.amountOfUnits.get(unitType);

		if (unitTypeAmount == null || unitTypeAmount == 0) {
			throw new NoSuchElementException("No such units in repository.");
		}

		this.amountOfUnits.put(unitType, --unitTypeAmount);
