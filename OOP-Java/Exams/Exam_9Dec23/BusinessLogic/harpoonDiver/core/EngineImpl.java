...
import Exams.Exam_9Dec23.BusinessLogic.harpoonDiver.common.Command;
...
public class EngineImpl implements Engine{
    ...
    private String addDivingSite(String[] data) {
        ...
        String[] seaCreatures = Arrays.stream(data).skip(1).toArray(String[]::new);
        return controller.addDivingSite(siteName, seaCreatures);
    }
